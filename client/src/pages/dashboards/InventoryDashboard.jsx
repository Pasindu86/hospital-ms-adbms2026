...
export default function InventoryDashboard() {
  ...
  const navItems = [
    { label: 'Dispensing & Billing', active: false, path: '/pharmacy/dispense', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" /><rect x="8" y="2" width="8" height="4" rx="1" ry="1" /></svg> },
    { label: 'Inventory Overview', active: true, path: '/pharmacy/inventory', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z" /><path d="m3.3 7 8.7 5 8.7-5" /><path d="M12 22V12" /></svg> }
  ];
        ...
        <main className="page-content">
          ...
          <div className="content-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 350px', gap: '24px' }}>
            ...
            <div className="right-sidebar">
              ...
              <div className="side-card">
                <div className="side-card-header">Inventory Guide</div>
                <div className="side-card-body" style={{ fontSize: '13px', color: '#475569', lineHeight: '1.6' }}>
                  <p>
                    This is an aggregated stock summary across all batch numbers. Navigate to 'Dispensing & Billing' to edit or add new drug batches.
                  </p>
                </div>
              </div>
            </div>
